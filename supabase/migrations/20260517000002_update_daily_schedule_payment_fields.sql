-- Migration: update get_daily_schedule to include payment fields
-- Purpose: Schedule details panel needs payment_method, payment_status, amount_paid
-- to render the PaymentActionMenu with correct current values.
