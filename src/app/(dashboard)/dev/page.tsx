...
const CATEGORIES: DevCategory[] = [
  {
    ...
    links: [
      ...
      { icon: "✨", label: "Services", href: "/owner/services" },
      {
        ...
        description: "Manage public homepage content, gallery, promotions, and before-you-book copy.",
      },
    ],
  },
  {
    ...
    links: [
      ...
      { icon: "🏠", label: "Spaces", href: "/manager/resources" },
  ...
  },
  {
    ...
    links: [
      { icon: "📋", label: "CRM Today", href: "/crm/today" },
  ...
  },
  {
    ...
    color: "var(--cs-sand)",
    links: [
      { icon: "🚗", label: "Driver Panel", href: "/driver", description: "Placeholder — home service dispatch coming soon." },
      { icon: "🧹", label: "Utility Panel", href: "/utility", description: "Placeholder — room prep and maintenance tasks coming soon." },
    ],
  },
  {
    title: "🌐 Public Facing",
