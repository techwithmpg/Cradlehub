...
export const metadata: Metadata = { title: "Trips - CradleHub Staff" };
  ...
  return (
    <>
      <div className="block md:hidden">
        <DriverTripsPage todayItems={data.items} historyItems={[]} detailsBasePath="/staff/driver/trips" />
      </div>
...
export default async function StaffDriverTripsPage() {
  ...
  return (
    <>
      <div className="block md:hidden">
        <DriverTripsPage todayItems={data.items} historyItems={history} detailsBasePath="/staff/driver/trips" />
      </div>
      <div className="hidden md:block">
        <HomeServiceDispatchWorkspace role="driver" data={data} />
      </div>
