...
export function DriverQuickActions() {
  ...
  const actions = [
    {
      label: "Map View",
      href: isCanonical ? "/staff/driver/map" : "/staff-portal/map",
      icon: Map,
      desc: "View route map",
    },
    {
      label: "Jobs",
      href: isCanonical ? "/staff/driver/trips" : "/staff-portal/jobs",
      icon: BriefcaseBusiness,
      desc: "All assigned jobs",
    },
    {
      label: "Update Status",
      href: isCanonical ? "/staff/driver/trips" : "/staff-portal/jobs/active",
      icon: RefreshCw,
      desc: "Current job status",
    },
    {
      label: "My Stats",
      href: isCanonical ? "/staff/driver/more" : "/staff-portal/stats",
      icon: TrendingUp,
