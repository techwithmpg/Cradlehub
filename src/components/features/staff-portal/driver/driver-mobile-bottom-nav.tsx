...
import { LayoutDashboard, Truck, Map, BriefcaseBusiness, MoreHorizontal } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "More", href: "/staff-portal/more", icon: MoreHorizontal, matchPaths: MORE_MATCH_PATHS },
];
