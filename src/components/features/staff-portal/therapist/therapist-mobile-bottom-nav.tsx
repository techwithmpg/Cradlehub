...
import { Activity, CalendarDays, Home, Plus, User } from "lucide-react";
import {
...
export function TherapistMobileBottomNav() {
  ...
  const items: FloatingMobileNavItem[] = [
    ...
    },
    {
      ...
      icon: ProgressIcon,
      active: pathname.startsWith("/staff-portal/service-progress"),
    },
    {
      label: "Profile",
  ...
  return (
    <FloatingMobileBottomNav
      items={items}
      centerAction={{ label: "Start", icon: PlusIcon, href: "/staff-portal/service-progress" }}
