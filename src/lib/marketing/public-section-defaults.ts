...
export type MarketingSectionDefault = {
  sectionKey: string;
  label: string;
  description: string;
  title: string;
...
export const PUBLIC_SITE_SECTION_DEFAULTS = [
  {
    sectionKey: "hero",
    label: "Hero",
  ...
  },
  {
    ...
    body: "Cradle is designed for the moments when your body asks for quiet and your schedule needs something simple. Guests can visit the spa or request home service when comfort at home is the better setting.",
    ctaLabel: "",
    ctaHref: "",
  ...
  },
  {
    ...
    body: "Booking is designed to be calm and transparent. Choose the setting first so the system can guide you toward the right service and schedule.",
    ctaLabel: "",
    ctaHref: "",
    imageUrl: "",
    secondaryImageUrl: "",
...
] as const satisfies readonly MarketingSectionDefault[];
