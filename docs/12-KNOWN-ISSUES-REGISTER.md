...
| C0B-006 | P1 | MITIGATED PENDING REVIEW | Governance | C0A found conflicting `docs/` and `.context/` mirrors. | Agents could follow stale instructions. | C0B external review | C0B establishes the active manifest; historical records are preserved. |
